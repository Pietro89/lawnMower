...
describe('MowLawner turning', () => {

    it('should hold the initial position', async () => {
        const mowLawner = new MowLawner({x: 1, y: 1, orientation: 'N'}, {x: 5, y: 5})
    ...
    it('should turn right (from west to north)', async () => {
        const mowLawner = new MowLawner({x: 1, y: 1, orientation: 'W'}, {x: 5, y: 5})
        mowLawner.turnRight()
        chai.expect(mowLawner.currentPosition.orientation).to.equal('N');
    })
})

describe('MowLawner mooving', () => {
    it('should moove from 0,0 to 0,1 when facing north', async () => {
        const mowLawner = new MowLawner({x: 0, y: 0, orientation: 'N'}, {x: 5, y: 5})
        mowLawner.moove()
    ...
    it('should moove from 5,5 to 5,4 when facing south', async () => {
        const mowLawner = new MowLawner({x: 5, y: 5, orientation: 'S'}, {x: 5, y: 5})
        mowLawner.moove()
    ...
    it('should moove from 5,5 to 4,5 when facing west', async () => {
        const mowLawner = new MowLawner({x: 5, y: 5, orientation: 'W'}, {x: 5, y: 5})
        mowLawner.moove()
    ...
    it('should moove from 0,0 to 1,0 when facing east', async () => {
        const mowLawner = new MowLawner({x: 0, y: 0, orientation: 'E'}, {x: 5, y: 5})
        mowLawner.moove()
    ...
    it('should not moove from 5,5 when facing north', async () => {
        const mowLawner = new MowLawner({x: 5, y: 5, orientation: 'N'}, {x: 5, y: 5})
        mowLawner.moove()
    ...
    it('should not moove from 0,0 when facing south', async () => {
        const mowLawner = new MowLawner({x: 0, y: 0, orientation: 'S'}, {x: 5, y: 5})
        mowLawner.moove()
    ...
    it('should not moove from 0,0 when facing west', async () => {
        const mowLawner = new MowLawner({x: 0, y: 0, orientation: 'W'}, {x: 5, y: 5})
        mowLawner.moove()
    ...
    it('should not moove from 5,5 when facing east', async () => {
        const mowLawner = new MowLawner({x: 5, y: 5, orientation: 'E'}, {x: 5, y: 5})
        mowLawner.moove()
